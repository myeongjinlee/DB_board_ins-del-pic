...
<head>
	<meta charset="utf-8" />
	<title>자유게시판 | Myeongjin's Library</title>
	...
	<article class="boardArticle">
		...
		<div id="boardWrite">
			<form action="./write_update.php" method="post" enctype="multipart/form-data">
				<?php
				if(isset($bNo)) { //submit시 게시판번호도 함께 보냄
					...
					<tbody>
						...
						<tr>
                            ...
                            <textarea name="bContent" id="bContent"
                                <?php echo isset($row['b_content'])?$row['b_content']:null?>></textarea></td>
						</tr>
						<tr>
							<th scope="row"><label for="bImage">이미지</label></th>
							<td class="image">
                            <input type="file" name="bImage" id="bImage" 
                                value="<?php echo isset($row['b_image'])?$row['b_image']:null?>"></td>
						</tr>
					</tbody>
				</table>
				<div class="btnSet">
